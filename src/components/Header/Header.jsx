        ...
        <div className="container mx-3 px-4">
          <div className="flex justify-between items-center">
            ...
            <ul className='hidden md:flex items-center gap-10'>
              ...
              <li className="relative font-medium py-[10px] text-[#1D2130] transition-all duration-300 hover:text-cyan-600 after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-cyan-600 after:transition-all after:duration-300 hover:after:w-full"><Link to="/contact">Contact</Link></li>
            </ul>
